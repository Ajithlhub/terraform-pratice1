...
resource "aws_instance" "server" {
 ...
 # }
  ...
  #provisioner "remote-exec" {  #sever inside
   # inline = [
    #  "touch /home/ubuntu/file200",
     # "echo 'hello from awsss' >> /home/ubuntu/file200"
    #]
  #}
  # provisioner "local-exec" {    #where terraform running inside directory
 ...
 resource "null_resource" "run_script" {
  provisioner "remote-exec" {
    ...
    inline = [
      "echo 'welcome back to my channel' >> /home/ubuntu/file200"
    ]
  }
